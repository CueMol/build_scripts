...
wget -c https://github.com/CueMol/povray_build/releases/download/v0.0.5/povray_macOS_ARM64.tar.bz2
xattr -cr povray_macOS_ARM64.tar.bz2
tar xjvf povray_macOS_ARM64.tar.bz2
